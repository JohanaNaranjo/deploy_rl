...
class Compra(db.Model):
    ...
    #db.relationship se usa para relacionar el UsuarioId el la Foreign Key y crear una relación entre los dos 
    #back_populates = "compras", es para la relación que tiene con las compras. uselist = False, single_parent=True
